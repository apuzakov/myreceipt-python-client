...
class ReceiptItems(object):
    ...
    def __init__(self, name=None, price=None, quantity=None, sum=None, tax=None):  # noqa: E501
        """ReceiptItems - a model defined in Swagger"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReceiptItems):
            return False
